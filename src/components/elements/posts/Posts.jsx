...
//     const token = useSelector((state) => state.auth?.token); // Берем токен из Redux
//     const userId = "67c6dda5f8f1aa5f3e93c0ea"; // Твой ID
//     // const [trDate, setTrDate]  = useState('nall')
...
//                 prevPosts.map((p) =>
//                     p._id === postId
//                         ? { ...p, likes: [...p.likes, { fromUser: userId }] }
//                         : p
//                 )
//             );
//         } catch (error) {
...
//     // Функция для удаления лайка (Dislike)
